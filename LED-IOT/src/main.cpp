...
const char *ap_ssid = "radya";
const char *ap_password = "radya123";
...
void setup() {
  ...
  webpage+= "<p>LED 4: ";
  webpage+= "<a href=\"LED4ON\"\"><button>ON</button></a><a href=\"LED4OFF\"\"><button>OFF</button></a></p>";
  ...
  server.on("/LED4ON", HTTP_GET, [](AsyncWebServerRequest *request){
  ...
  server.on("/LED4OFF", HTTP_GET, [](AsyncWebServerRequest *request){
